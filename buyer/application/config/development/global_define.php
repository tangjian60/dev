...
define('HILTON_NAME', '小红包');
define('HILTON_SLOGAN', '小小红包赚钱快');
define('CUSTOM_SERVICE_QQ', '800853375');
define('CUSTOM_SERVICE_WECHAT', 'xxxxxx');
define('CUSTOM_SERVICE_GROUP', '800853375');
define('SELLER_PROMOTE_LINK', 'http://zcm.local.com/shang/user/register?r=');
define('BUYER_PROMOTE_LINK', 'http://zcm.local.com/buyer/user?r=');

define('TRUNK_PROMOTE_LINK', 'http://zcm.local.com/');
define('IOS_APP_URL', 'http://fandong.me/app/app.php/37');
define('ANDROID_APP_NAME', 'xhb.apk');
...
define('PROMOTION_FIRST_REWARD', 10);
...
define('SHOP_TO_NICK_INTERVAL', 15);
define('SHOP_TO_BUYER_INTERVAL', 15);
...
define('ITEMS_PER_LOAD', 30);
define('MAX_BIND_ACCOUNT_CNT', 3);
define('MAX_CLAIM_TASK_LIMIT', 1);
define('MAX_DF_TASKS_PER_NICK', 5);
define('MAX_PDD_TASKS_PER_NICK', 5); //拼多多每个账号每天接单上限
...
define('HELP_LINK', 'http://help.dhl188.test.com/');

//define('REDIS_SERVER', 'redis.zcm889.com');
...
define('BANGDING_TYPE_TAOBAO',1);  // 买家提现收取1%的手续费
define('BANGDING_TYPE_PINDUODUO',3);  // 买家提现收取1%的手续费
define('PRICE_DIFFERENCE',30);  // 实付金额与商家垫付本金差额中间值
