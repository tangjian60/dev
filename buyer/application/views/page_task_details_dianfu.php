        ...
        <div class="page-content">
                ...
                <div class="list-group">
                    <ul>
                        ...
                        <?php if (in_array($task_detail->task_method, array('聚划算', '淘抢购', '天天特价'))): ?>
                            <li class="item-content">
                                <div class="item-media"><img class="img-show-gallery" src="<?php echo CDN_DOMAIN . $task_detail->task_method_details; ?>" width="80px"></div>
                            </li>
                        <?php else: ?>
                            <li class="item-content">
                                <div class="item-inner">
                        ...
                        <ul>
                            ...
                            <li class="item-content" style="margin-left:0px;">
                                <section id="cd-timeline" class="cd-container">
                                            ...
                                            <div class="pic-content">
                                                <div class="pic-tipk">
                                                    <div class="row no-gutter">
                                                        <div class="col-75">货比：对同类商品的浏览，货比不可截图（详情页随机浏览长按保存图片上传），主搜必须截图</div>
                                                    </div>
                                                </div>
                                                <div class="pic-tipk">
                                                    <div class="row no-gutter">
                                                        <div class="col-25 f12-orange btn-show-tips" data-tip-url="<?php echo CDN_BINARY_URL; ?>tips/huobi_jietu1.jpg" style="margin-left: 5%;">截图方法1</div>
                                                        <div class="col-25 f12-orange btn-show-tips" data-tip-url="<?php echo CDN_BINARY_URL; ?>tips/huobi_jietu2.jpg" style="margin-right: 40%;">截图方法2</div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-50 align-center">
                                                        ...
                                                        <div class="picx-title">
                                                            <span class="f12-red">货比不可截图（请长按保存图片）</span>
                                                            <br>
                                                            <span class="f12-grass-green">(浏览≥1分钟)</span>
                                                        </div>
                                                    </div>
                                    ...
                                    <?php endif; ?>
                                    <?php if (!empty($task_detail->is_add_cart) && $task_detail->is_add_cart != NOT_AVAILABLE): ?>
                                        <div class="cd-timeline-block">
                                            <div class="cd-timeline-img cd-picture"><?php echo $step++; ?></div>
                                            <div class="cd-timeline-content">
                                                <div class="pic-title">加入购物车购买</div>
                                                <div class="pic-content">
                                                    <div class="pic-tipk">
                                                        <div class="row no-gutter">
                                                            <div class="col-75">该操作<span style="color:red;">必须完成</span>，无需截图，由平台进行技术监控</div>
                                    ...
                                    <?php endif; ?>
                                    <?php if (!empty($task_detail->is_compete_add_cart) && $task_detail->is_compete_add_cart != NOT_AVAILABLE): ?>
                                        <div class="cd-timeline-block">
                                            <div class="cd-timeline-img cd-picture"><?php echo $step++; ?></div>
                                            <div class="cd-timeline-content">
                                                <div class="pic-title">将其它店铺的商品加入购物车</div>
                                                <div class="pic-content">
                                                    <div class="pic-tipk">
                                                        <div class="row no-gutter">
                                                            <div class="col-75">该操作<span style="color:red;">必须完成</span>，无需截图，由平台进行技术监控</div>
            ...
            <?php if ($task_detail->status == Taskengine::TASK_STATUS_DPJ || $task_detail->status == Taskengine::TASK_STATUS_HPSH_BTG): ?>
                <div class="row no-gutter" style="margin:30px 0 80px 0;">
                    <div class="col-100">
                        <a href="#" class="button button-big button-fill color-blue task-go-btn btn-haoping-commit" data-url="<?php echo base_url('task/task_haoping_handle'); ?>">提交好评审核</a>
                    </div>
                </div>
            <?php endif; ?>
