        ...
        <div class="list-group">
            <ul>
                ...
                <li>
                    <a href="#" class="item-content external">
                        <div class="item-inner">
                            <div class="item-title">花呗限制：</div>
                            <div class="item-after">
                                <?php
                                if (isset($task_info->is_huabei) && $task_info->is_huabei != NOT_AVAILABLE) {
                                    echo '仅限花呗用户接单';
                                } else {
                                    echo '无限制';
                                }
                ...
                <li>
                    <a href="#" class="item-content external">
                        <div class="item-inner">
                            <div class="item-title">等级要求：</div>
                            <div class="item-after">
                                <?php
                                if (isset($task_info->tb_rate_limit) && $task_info->tb_rate_limit != NOT_AVAILABLE) {
                                    echo Tbrateenum::_get_name($task_info->tb_rate_limit) . '及以上';
                                } else {
                                    echo '无限制';
                                }
                                ?>
                ...
                <li>
                    <a href="#" class="item-content external">
                        <div class="item-inner">
                            <div class="item-title">性别要求：</div>
                            <div class="item-after">
                                <?php
                                if (isset($task_info->sex_limit) && $task_info->sex_limit != NOT_AVAILABLE) {
                                    echo $task_info->sex_limit;
                                } else {
                                    echo '无限制';
                                }
                                ?>
                ...
                <li>
                    <a href="#" class="item-content external">
                        <div class="item-inner">
                            <div class="item-title">年龄要求：</div>
                            <div class="item-after">
                                <?php
                                if (isset($task_info->age_limit) && $task_info->age_limit != NOT_AVAILABLE) {
                                    switch ($task_info->age_limit) {
                                        case 15 :
                                            echo '15-25岁';
                                            break;
                                        case 26 :
...
<!--                    <a href="#" class="item-content external">-->
<!--                        <div class="item-inner">-->
<!--                            <div class="item-title">区域限制：</div>-->
<!--                            <div class="item-after">-->
<!--                                --><?php
//                               if (isset($task_info->tb_area_limit) && $task_info->tb_area_limit != NOT_AVAILABLE) {
//                                    echo $task_info->tb_area_limit;
//                                } else {
//                                    echo '无限制';
//                                }
//                                ?>
...
//                echo '<a href="#" class="button button-big button-fill color-gray">账号【' . $v->tb_nick . '】不符合要求</a>';
    ...
    <div class="content-block" style="color:#FF4400;">
        <span>温馨提示：账号不符合要求可能是由于你的淘宝账号不符合卖家设置的筛选规则，或已经超过了平台设置的每天最大允许的接单数量。</span>
    </div>
<?php endif ?>