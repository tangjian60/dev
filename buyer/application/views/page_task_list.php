...
<div class="pages navbar-through fixed-through">
    <div data-page="page-task-list" class="page">
        <div class="page-content">
            <div class="list-block hilton-infinite-list media-list" style="margin-top:0;">
                <input type="hidden" id="b_type" value="<?php echo $task_type; ?>">
                <ul></ul>
            </div>
            <div class="infinite-scroll-preloader">
                <a id="load-more" href="#" class="button button-round" data-url="<?php echo base_url('task/task_list'); ?>" style="margin:0 35%;color:#007aff;">加载更多</a>
