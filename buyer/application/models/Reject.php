...
//    }
    ...
    public function get_reject_detail ($id)
    {
        $this->db->select(array('id', 'task_id', 'gmt_create', 'buyer_tb_nick', 'task_status', 'state'));
        $this->db->where('id', intval($id));
        return $this->db->get(self::DB_SELLER_REJECT_RECORDS)->row();
    }
