...
function change(v){
    ...
    with(ss){
        length = 0;
        options[0]=new Option(def_select_name[v], def_select_name[v]);
...
dsy.add("0_16_0",["中原区","二七区","管城回族区","金水区","上街区","惠济区","新郑市","登封市","新密市","巩义市","荥阳市","中牟县","城关镇","郑东新区"]);
...
dsy.add("0_19_13",["石岐","东区","西区","环城","中山港","五桂山","港口","三角","民众","南朗","三乡","坦洲","神湾","板芙","大涌","沙溪","横栏","古镇","小榄","东凤","南头","阜沙","黄圃","东升"]);
...
dsy.add("0_30_2",["石河子市","阿拉尔市","图木舒克市","五家渠市","喀什市"]);
...
dsy.add("0_30",["乌鲁木齐市","克拉玛依市","喀什地区","阿克苏地区","和田地区","吐鲁番地区","哈密地区","克孜勒苏柯自治州","博尔塔拉自治州","昌吉自治州","巴音郭楞自治州","伊犁自治州","塔城地区","阿勒泰地区"]);
